...
use Phabalicious\Scaffolder\Transformers\Utils\ResponsiveImageGroupOcc;
use Phabalicious\Scaffolder\Transformers\Utils\ResponsiveImageOcc;
use Phabalicious\Scaffolder\Transformers\Utils\PlaceholderService;
use Phabalicious\Scaffolder\Transformers\Utils\ConfigAccumulator;
use Phabalicious\Method\TaskContextInterface;
use Phabalicious\Utilities\Utilities;

class ResponsiveImageOccTransformer extends YamlTransformer implements DataTransformerInterface
{
    public static function getName() : string
    {
        return 'responsive_image_occ';
    }
    ...
    public function transform(TaskContextInterface $context, array $files, $target_path): array
    {
        ...
        foreach ($this->iterateOverFiles($context, $files) as $data) {
            ...
            $transformer = new ResponsiveImageGroupOcc($config_accumulator, $placeholder_service, $data);
