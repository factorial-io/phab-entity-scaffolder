...
class ResponsiveImageOccTest extends BaseScaffoldingTest
{
    ...
    public function testResponsiveImages()
    {
        ...
        $this->copyBaseline(
            'baseline/responsive_image_occ/index',
            'results/responsive_image_occ/index',
            []
        );
        ...
        $commandTester->execute(array(
            'scaffold-path' => $this->getcwd().'/assets/responsive_image_occ/index.yml'
        ));
